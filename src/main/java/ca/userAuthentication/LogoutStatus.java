...
/**
 * Protobuf enum {@code ca.userAuthentication.LogoutStatus}
 */
public enum LogoutStatus
    implements com.google.protobuf.ProtocolMessageEnum {
  /**
   * <code>LOGGED_OUT_SUCCESSFULLY = 0;</code>
   */
   ...
   * <code>LOGGED_OUT_SUCCESSFULLY = 0;</code>
   */
  public static final int LOGGED_OUT_SUCCESSFULLY_VALUE = 0;
  /**
   * <code>INVALID_USERSTATUS = 1;</code>
   */
  ...
  public static LogoutStatus forNumber(int value) {
    switch (value) {
      case 0: return LOGGED_OUT_SUCCESSFULLY;
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return ca.userAuthentication.userAuthenticationProto.getDescriptor().getEnumTypes().get(1);
  }
  ...
  // @@protoc_insertion_point(enum_scope:ca.userAuthentication.LogoutStatus)
}
